...
CREATE TABLE IF NOT EXISTS "public"."keep_alive_logs" (
    ...
    "source" "text" DEFAULT 'keep-alive-saas'::"text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL
);


ALTER TABLE "public"."keep_alive_logs" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."keep_alive_logs"
    ADD CONSTRAINT "keep_alive_logs_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."todo_items"
    ADD CONSTRAINT "todo_items_group_id_list_id_fkey" FOREIGN KEY ("group_id", "list_id") REFERENCES "public"."todo_groups"("id", "list_id") ON DELETE CASCADE;
...
GRANT ALL ON TABLE "public"."keep_alive_logs" TO "anon";
GRANT ALL ON TABLE "public"."keep_alive_logs" TO "authenticated";
